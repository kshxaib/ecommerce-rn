...
export default function ProfileScreen() {
    ...
    const handleMenuPress = (action) => {
        ...
        else if (action === "/orders") router.push(action);
        else if (action === "/addresses") router.push(action);
        else if (action === "/wishlist") router.push(action);
    }
    ...
    return (
        ...
        >
            ...
            <View className="px-6 pb-8">
                <View className="bg-#282828 rounded-3xl p-6">
                    <View className="flex-row items-center">
                        <View className="relative">
                            ...
                            />
                            <View className="absolute -bottom-1 -right-1 bg-#1DB954 rounded-full size-7 items-center justify-center border-2 border-#282828">
            ...
            <View className="flex-row flex-wrap gap-2 mx-6 mb-3">
                {
                    MENU_ITEMS.map((item) => (
                        <TouchableOpacity
                            key={item.id}
                            className="bg-#282828 rounded-2xl p-6 items-center justify-center"
                            style={{ width: "48%" }}
                            activeOpacity={0.7}
                        ...
                        >
                            ...
                            <Text className="text-#FFFFFF font-bold text-base">{item.title}</Text>
                        </TouchableOpacity>
                    ))
                }
            </View>

import { View, Text, Modal, TouchableOpacity, ScrollView, TextInput, ActivityIndicator, Switch, KeyboardAvoidingView, Platform } from 'react-native'
import React from 'react'
import { Ionicons } from '@expo/vector-icons'

export default function AddressFormModal({ addressForm,
    isAddingAddress,
    isEditing,
    isUpdatingAddress,
    onClose,
